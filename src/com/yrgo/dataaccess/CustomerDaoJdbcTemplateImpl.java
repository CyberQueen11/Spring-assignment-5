...
public class CustomerDaoJdbcTemplateImpl implements CustomerDao{
    ...
    private static final String CREATE_CUSTOMER_TABLE_SQL = "CREATE TABLE CUSTOMER (CUSTOMER_ID VARCHAR(50) PRIMARY KEY, COMPANY_NAME VARCHAR(100), EMAIL VARCHAR(100), TELEPHONE VARCHAR(15), NOTES VARCHAR(255))";
    private static final String CREATE_CALLS_TABLE_SQL = "CREATE TABLE CALLS (ID INTEGER PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,CUSTOMER_ID VARCHAR(50),TIME_AND_DATE TIMESTAMP,NOTES VARCHAR(255),FOREIGN KEY (CUSTOMER_ID) REFERENCES CUSTOMER(CUSTOMER_ID))";
